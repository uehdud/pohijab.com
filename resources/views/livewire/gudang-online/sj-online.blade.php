                ...
                <div x-data="{}">
                    <table class="table text-center text-sm table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $i++ }}</td>
                                <td>{{ $cart->produks['kode_barang'] ?? ''}}</td>
                                <td>{{ $cart->produks->warna['nama_warna'] ?? ''}}</td>
                                <td>{{ $cart->produks->ukuran['nama_ukuran'] ?? ''}}</td>
                                <td>
                                ...
                                <td>
                                    {{ $cart->produks['jumlah_stok_online']  ?? ''}}
                                </td>
                                <td>
