<div>
    ...
    <x-jet-button wire:loading wire:target="saveFotoVideoProduk" wire:click.prevent="saveFotoVideoProduk"><i class="fas fa-spinner fa-spin text-2xl"></i></x-jet-button>
