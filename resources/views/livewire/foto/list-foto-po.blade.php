                    ...
                    <div class="card" style="box-shadow: none;">
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="row mt-1 text-right">
                                <small class="m-0" style="font-size: 12px;">Created at {{ date('j F, Y, g:i A', strtotime($item->created_at))  }}</small>
                                @if(!is_null($item))
                                <small style="font-size: 12px;">Oleh {{ $item->userUpload->name }}</small>
                            </div>
                        </div>
                        @endif
                        <a style="text-decoration: none;" class="text-black" href="{{ route('foto.fotos.edit', $item->kode_barang) }}">
